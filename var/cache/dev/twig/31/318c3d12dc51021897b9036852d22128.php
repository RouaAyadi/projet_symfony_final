...
class __TwigTemplate_b3508e471b1eb15e6f24b3f4c3dacf99 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 8
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["location"]) || array_key_exists("location", $context) ? $context["location"] : (function () { throw new RuntimeError('Variable "location" does not exist.', 8, $this->source); })()), "html", null, true);
        yield "\">";
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["location"]) || array_key_exists("location", $context) ? $context["location"] : (function () { throw new RuntimeError('Variable "location" does not exist.', 8, $this->source); })()), "html", null, true);
        yield "</a>.</h1>
...
{% endblock %}
", "@WebProfiler/Profiler/toolbar_redirect.html.twig", "C:\\Users\\lenovo\\Documents\\GitHub\\projet_final\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\toolbar_redirect.html.twig");
    }
}
