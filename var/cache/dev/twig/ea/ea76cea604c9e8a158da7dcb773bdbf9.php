...
class __TwigTemplate_50e4ecc6b261b09f0577bb7a1156241b extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "requestCount", [], "any", false, false, false, 4)) {
            ...
            ";
                ...
                yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 8, $this->source); })()), "requestCount", [], "any", false, false, false, 8), "html", null, true);
                yield "</span>
        ";
        ...
        ";
            ...
            $context["text"] = ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
                ...
                <span>";
                // line 14
                yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 14, $this->source); })()), "requestCount", [], "any", false, false, false, 14), "html", null, true);
                yield "</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                ...
                yield "\">";
                yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 18, $this->source); })()), "errorCount", [], "any", false, false, false, 18), "html", null, true);
                yield "</span>
            </div>
        ";
            })() ?? new \EmptyIterator())) ? '' : new Markup($tmp, $this->env->getCharset());
    ...
    ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 30, $this->source); })()), "requestCount", [], "any", false, false, false, 30)) {
            ...
            ";
            // line 32
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 32, $this->source); })()), "requestCount", [], "any", false, false, false, 32), "html", null, true);
            yield "
        </span>
    ";
        }
...
";
    ...
    ";
            ...
            <div class=\"metric\">
                <span class=\"value\">";
            // line 47
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 47, $this->source); })()), "requestCount", [], "any", false, false, false, 47), "html", null, true);
            yield "</span>
            ...
            <div class=\"metric\">
                <span class=\"value\">";
            // line 51
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 51, $this->source); })()), "errorCount", [], "any", false, false, false, 51), "html", null, true);
            yield "</span>
        ...
        <div class=\"sf-tabs\">
            ...
            foreach ($context['_seq'] as $context["name"] => $context["client"]) {
                // line 58
                yield "                <div class=\"tab ";
                yield (((Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 58)) == 0)) ? ("disabled") : (""));
                yield "\">
                    <h3 class=\"tab-title\">";
                // line 59
                yield Twig\Extension\EscaperExtension::escape($this->env, $context["name"], "html", null, true);
                yield " <span class=\"badge\">";
                yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 59)), "html", null, true);
                yield "</span></h3>
                    <div class=\"tab-content\">
                        ";
                // line 61
                if ((Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 61)) == 0)) {
                    // line 62
                    yield "                            <div class=\"empty\">
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
                        ...
                        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "info", [], "any", false, true, false, 70), "response_headers", [], "any", true, true, false, 70)) {
                            ...
                            foreach ($context['_seq'] as $context["_key"] => $context["header"]) {
                                ...
                                if (CoreExtension::matches("/^x-debug-token: .*\$/i", $context["header"])) {
                                    // line 73
                                    yield "                                            ";
                                    $context["profiler_token"] = Twig\Extension\CoreExtension::slice($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["header"], "getValue", [], "any", false, false, false, 73), Twig\Extension\CoreExtension::lengthFilter($this->env, "x-debug-token: "));
                                    // line 74
                                    yield "                                        ";
                                }
                                // line 75
                                ...
                                if (CoreExtension::matches("/^x-debug-token-link: .*\$/i", $context["header"])) {
                                    // line 76
                                    yield "                                            ";
                                    $context["profiler_link"] = Twig\Extension\CoreExtension::slice($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["header"], "getValue", [], "any", false, false, false, 76), Twig\Extension\CoreExtension::lengthFilter($this->env, "x-debug-token-link: "));
                                    // line 77
                                    yield "                                        ";
                                }
                                // line 78
                        ...
                        yield "                                <table>
                                    ...
                                    <tr>
                                        <th>
                                            <span class=\"label\">";
                        // line 84
                        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "method", [], "any", false, false, false, 84), "html", null, true);
                        yield "</span>
                                        </th>
                                        <th class=\"full-width\">
                                            ";
                        // line 87
                        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "url", [], "any", false, false, false, 87), "html", null, true);
                        yield "
                                            ";
                        // line 88
                        ...
                        if ( !(null === CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 97))) {
                            ...
                            // line 99
                            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 99), "html", null, true);
                            yield "\">curl</button>
                                            </th>
                                        ";
                        }
                        ...
                        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["responseStatus"]) || array_key_exists("responseStatus", $context) ? $context["responseStatus"] : (function () { throw new RuntimeError('Variable "responseStatus" does not exist.', 114, $this->source); })()), "html", null, true);
                        yield "\">
                                                ";
                        // line 115
                        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "http_code", [], "any", false, false, false, 115), "html", null, true);
                        yield "
                                            </span>
                                        </th>
                                        <td";
                        ...
                        if (((isset($context["profiler_token"]) || array_key_exists("profiler_token", $context) ? $context["profiler_token"] : (function () { throw new RuntimeError('Variable "profiler_token" does not exist.', 121, $this->source); })()) && (isset($context["profiler_link"]) || array_key_exists("profiler_link", $context) ? $context["profiler_link"] : (function () { throw new RuntimeError('Variable "profiler_link" does not exist.', 121, $this->source); })()))) {
                            ...
                            yield "                                            <td>
                                                <span><a href=\"";
                            // line 123
                            yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["profiler_link"]) || array_key_exists("profiler_link", $context) ? $context["profiler_link"] : (function () { throw new RuntimeError('Variable "profiler_link" does not exist.', 123, $this->source); })()), "html", null, true);
                            yield "\" target=\"_blank\">";
                            yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["profiler_token"]) || array_key_exists("profiler_token", $context) ? $context["profiler_token"] : (function () { throw new RuntimeError('Variable "profiler_token" does not exist.', 123, $this->source); })()), "html", null, true);
                            yield "</a></span>
                                            </td>
                                        ";
                        }
...
";
    ...
    {
        return array (  422 => 135,  419 => 134,  411 => 131,  408 => 130,  399 => 126,  391 => 123,  388 => 122,  386 => 121,  381 => 119,  375 => 118,  369 => 115,  364 => 114,  361 => 113,  358 => 112,  355 => 111,  352 => 110,  349 => 109,  346 => 108,  344 => 107,  337 => 102,  331 => 99,  328 => 98,  325 => 97,  319 => 93,  317 => 92,  314 => 91,  308 => 89,  306 => 88,  302 => 87,  296 => 84,  290 => 80,  287 => 79,  281 => 78,  278 => 77,  275 => 76,  272 => 75,  269 => 74,  266 => 73,  263 => 72,  258 => 71,  255 => 70,  252 => 69,  249 => 68,  245 => 67,  242 => 66,  236 => 63,  233 => 62,  231 => 61,  224 => 59,  219 => 58,  215 => 57,  206 => 51,  199 => 47,  195 => 45,  189 => 41,  187 => 40,  184 => 39,  174 => 38,  162 => 35,  156 => 32,  153 => 31,  151 => 30,  146 => 28,  141 => 27,  131 => 26,  117 => 22,  114 => 21,  106 => 18,  99 => 14,  95 => 12,  93 => 11,  90 => 10,  84 => 8,  82 => 7,  77 => 6,  74 => 5,  71 => 4,  61 => 3,  38 => 1,);
    }
...
{% endblock %}
", "@WebProfiler/Collector/http_client.html.twig", "C:\\Users\\lenovo\\Documents\\GitHub\\projet_final\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\http_client.html.twig");
    }
}
