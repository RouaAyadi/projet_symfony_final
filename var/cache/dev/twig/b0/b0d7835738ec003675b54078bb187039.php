...
class __TwigTemplate_3bcf09b2c724e0ffaa1917a9b8000c00 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        if ((Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 1, $this->source); })()), 0, [], "array", false, false, false, 1)) > 1)) {
            // line 2
            yield "    ";
            // line 3
        ...
        <thead>
            ...
            $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::getArrayKeysFilter(CoreExtension::getAttribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 6, $this->source); })()), 0, [], "array", false, false, false, 6)));
        ...
        <tbody>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                ...
                foreach ($context['_seq'] as $context["key"] => $context["item"]) {
                    // line 15
                    yield "                    <td>";
                    yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::replaceFilter($context["item"], ["," => ", "]), "html", null, true);
                    yield "</td>
                ";
                }
                $_parent = $context['_parent'];
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                // line 25
                yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::first($this->env, $context["row"]), "html", null, true);
                yield "
";
            }
            $_parent = $context['_parent'];
...
{% endif %}
", "@Doctrine/Collector/explain.html.twig", "C:\\Users\\lenovo\\Documents\\GitHub\\projet_final\\vendor\\doctrine\\doctrine-bundle\\templates\\Collector\\explain.html.twig");
    }
}
